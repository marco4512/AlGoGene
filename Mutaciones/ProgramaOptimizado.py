...
print("Ingresa el numero de generaciones que quieres implementar")
generaciones=input()
...
DecimalesAEvaluar=[]
d=[]
def GenerarPoblacionInicial (Parejas,Gene,cont,cont2,contaa,Cadena,DecimalDespuesDelPunto,DecimalesAEvaluar,d):
    ...
    df1.to_excel ("./Monogamia "+str((Gene+1))+".xlsx",sheet_name="Monogamia", header=True,index=False)
    OriginalMuta=[]
    yc=0
    print("---------------------------------Poligamo------------------------------")
    for o in Original:
    ...
    df2.to_excel ("./Poligamia "+str((Gene+1))+".xlsx",sheet_name="Poligamia", header=True,index=False) 
    print(df2)

for Gene in range(int(generaciones)):
    GenerarPoblacionInicial(Parejas,Gene,cont,cont2,contaa,Cadena,DecimalDespuesDelPunto,DecimalesAEvaluar,d)
    cont=0
    cont2=0
    contaa=0
    Cadena=""
